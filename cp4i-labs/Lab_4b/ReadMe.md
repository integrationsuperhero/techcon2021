...
1\. Click on the **Gateway** tab.   This is where we will setup our Gateway and Portal setting for our API.  Make sure that all your updates are saved by checking the upper right cornor. Click on the **Properties** on the left menu. 
...
3\. You will see you have both opertions available for your API.  Select the one that will return the first 2 Accounts and click **Send**.
...
9\. Once you are logged in, you can explorer varies sections in the developer portal.   For now, lets go the Account Product we created and Published to. 

![alt text][pic44]

10\. Now from the Products page, we see our API for ServiceNow Accounts and below that you see Plans.  This can be configured back in the Products section where you may add plans for Silver and Gold plans.   We just have the default for this one. Click on the API tile.
